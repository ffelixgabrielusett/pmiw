class Tarzan {
  constructor(posX, posY, tarzanImgs, corazonImg, sonidoPierdeVida, frutaImg) {
    this.posX = posX;
    this.posY = posY;
  ...
  dibujar() {
    ...
    if (this.puedeDisparar) {
      image(this.tarzanImgs[0], this.posX, this.posY- 50, 60, 100); //si tengo bala esta normal
    } else {
      image(this.tarzanImgs[1], this.posX, this.posY- 50, 60, 100); //si no tiene bala está rojo
    }
  }
